/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ba36d9bfe138667abfae7ac54f837a02)
// Runtime types generated with workerd@1.20260811.1 2026-08-12 
interface __BaseEnv_Env {
	HARBOR_OFFLINE_MSG_TTL_DAYS: "7";
	HARBOR_OFFLINE_GRACE_MS: "30000";
	HARBOR_MAX_FRAME_BYTES: "262144";
	HARBOR_REGISTRY: DurableObjectNamespace<import("./src/index").HarborRegistry>;
	HARBOR_PAIR: DurableObjectNamespace<import("./src/index").HarborPair>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "HarborRegistry" | "HarborPair";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HARBOR_OFFLINE_MSG_TTL_DAYS" | "HARBOR_OFFLINE_GRACE_MS" | "HARBOR_MAX_FRAME_BYTES">> {}
}
