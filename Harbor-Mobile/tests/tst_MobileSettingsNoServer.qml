...
TestCase {
    ...
    function test_host_prepoints_default_network() {
        ...
        verify(qml.responseText.indexOf("[2804:d59:8777:ad00:3a30:f9ff:fe3e:de81]:9091") >= 0,
        ...
        verify(qml.responseText.indexOf("oracleDefaultAddress") >= 0,
               "host must honor the baked Oracle default when present")
    }
}
