                ...
                ColumnLayout {
                    ...
                    HarborSectionCard {
                        ...
                        ColumnLayout {
                                ...
                                HarborButton {
                                    ...
                                    // qmllint disable unqualified
                                     enabled: typeof HarborUpdater !== "undefined"
                                             && HarborUpdater.lastUpdateResult !== "recovery_required"
                            ...
                            Text {
                                // qmllint disable unqualified
                                visible: typeof HarborUpdater !== "undefined"
                                         && String(HarborUpdater.lastUpdateResult || "").length > 0
                                text: visible
                                    ? I18n.t("update.result." + String(HarborUpdater.lastUpdateResult), {
                                        version: HarborUpdater.lastUpdateVersion,
                                        error: HarborUpdater.lastUpdateError
                                    }) : ""
                                // qmllint enable unqualified
                                color: typeof HarborUpdater !== "undefined"
                                       && HarborUpdater.lastUpdateResult === "recovery_required"
