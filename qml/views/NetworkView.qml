        ...
        HarborPage {
            ...
            GridLayout {
                ...
                readonly property var diagCardsModel: {
                    ...
                    var udpReachable = diag !== null && diag.udpReachable
                    var relayActive = diag !== null && diag.relayActive
                    return [
                        {
                        ...
                        {
                            labelKey: "network.diag.udp",
                            iconName: "chevron-up",
                            value: udpReachable && diag.udpRttMs !== undefined
                                   ? root.msValue(diag.udpRttMs)
                                   : udpReachable ? I18n.t("network.diag.online")
                                   : I18n.t("network.diag.udpDown"),
                            trendText: I18n.t("network.metric.live.measured")
                        },
                        {
                            labelKey: "network.diag.relay",
                            iconName: "network",
                            value: relayActive ? I18n.t("network.diag.relayActive")
                                   : I18n.t("network.diag.relayIdle"),
                            trendText: ""
                        }
                    ]
                }
