            ...
            GridLayout {
                ...
                HarborSectionCard {
                    ...
                    Flow {
                        ...
                        HarborButton {
                            text: I18n.t("developer.pairing.openHome")
                            variant: "secondary"
                            onClicked: {
                                panel.close()
                                panel.pairingRequested()
                                MockController.openPairing("home")
                            }
                        }

                        HarborButton {
                            text: I18n.t("developer.pairing.openConnecting")
                            variant: "secondary"
                            onClicked: {
                                panel.close()
                                panel.pairingRequested()
                                MockController.openPairing("home")
                                MockController.connectWithHarborId("harbor-dead0002")
                            }
                        }
                        ...
                        HarborButton {
                            ...
                            onClicked: {
                                ...
                                panel.pairingRequested()
                                MockController.openPairing("home")
                                MockController.connectWithHarborId("harbor-00000000")
                            }
                        }
                    }
                }
