...
pub use pairing::{
    LEGACY_K11_ENDPOINTS, PairingError, PairingPhase, PairingRole, PairingSession, PinMigration,
    PinMigrationError, is_migration_source, load_server_pin, migrate_server_pin, oracle_endpoint,
    register_identity, server_pin_needs_migration, store_server_pin,
};
