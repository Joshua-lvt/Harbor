  ...
  return (
    <div className="window-main relative flex h-screen overflow-hidden">
      ...
      <div className="flex h-full flex-1 flex-col gap-5 overflow-y-auto p-6">
        ...
        {/* Feature 5 — quick-message presets + custom text. Notification-only
            E2E quick-messages (rides the existing chat.enc path). Sits above the
            action bar so "Abrir chat" stays the bottom anchor. */}
        <QuickMessageBar
          identity={identity}
        ...
        {/* Right-aligned action bar pinned to the bottom of the column */}
