...
export function OceanBackground() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      {/* Top soft blue glow */}
      <div className="ocean-decor absolute -top-24 left-1/2 h-48 w-[36rem] -translate-x-1/2 rounded-full bg-harbor-sea/15 blur-3xl" />
      ...
      <div className="ocean-decor absolute left-[12%] top-[18%] h-24 w-24 rounded-full bg-white/20 blur-2xl dark:bg-harbor-ice/10" />
      <div className="ocean-decor absolute right-[16%] top-[30%] h-16 w-16 rounded-full bg-harbor-ice/20 blur-2xl dark:bg-harbor-ice/10" />
      <div className="ocean-decor absolute left-[42%] top-[14%] h-10 w-10 rounded-full bg-white/25 blur-xl dark:bg-harbor-ice/10" />

      {/* Blurred waves along the bottom — wide, flat, low-opacity ocean hint */}
      <div className="ocean-decor absolute -bottom-16 -left-10 h-40 w-[28rem] rounded-[50%] bg-harbor-sea/10 blur-3xl" />
      <div className="ocean-decor absolute -bottom-20 right-0 h-44 w-[32rem] rounded-[50%] bg-harbor-ice/10 blur-3xl" />
    </div>
  );
}
